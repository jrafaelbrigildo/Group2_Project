...
public class Result_python extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Result_python frame = new Result_python();
	...
	public Result_python() {
		...
		exitBtn.setIcon(new ImageIcon(Result_python.class.getResource("/images/exit1.png")));
		exitBtn.setBounds(10, 8, 179, 43);
		panel_1.add(exitBtn);
		exitBtn.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				exitBtn.setIcon(new ImageIcon(Result_python.class.getResource("/images/exit1_hover.png")));
			}
			@Override
		...
		playAgainBtn.setIcon(new ImageIcon(Result_python.class.getResource("/images/playagain.png")));
		playAgainBtn.setBounds(10, 8, 179, 43);
		panel_2.add(playAgainBtn);
		playAgainBtn.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				playAgainBtn.setIcon(new ImageIcon(Result_python.class.getResource("/images/playagain_hover.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				playAgainBtn.setIcon(new ImageIcon(Result_python.class.getResource("/images/playagain.png")));
		...
		double score = question_python.scores;
		...
		label_1.setIcon(new ImageIcon(Result_python.class.getResource("/images/resultbg.png")));
