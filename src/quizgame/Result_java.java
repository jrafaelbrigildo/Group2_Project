...
public class Result_java extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Result_java frame = new Result_java();
	...
	public Result_java() {
		...
		exitBtn.setIcon(new ImageIcon(Result_java.class.getResource("/images/exit1.png")));
		exitBtn.setBounds(10, 8, 179, 43);
		panel_1.add(exitBtn);
		exitBtn.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				exitBtn.setIcon(new ImageIcon(Result_java.class.getResource("/images/exit1_hover.png")));
			}
			@Override
		...
		double score = question_java.scores;
		...
		label_1.setIcon(new ImageIcon(Result_java.class.getResource("/images/resultbg.png")));
